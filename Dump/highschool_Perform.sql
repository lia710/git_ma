...
CREATE TABLE `Perform` (
  ...
  `pstandard` varchar(100) DEFAULT NULL,
  `psdate` date NOT NULL,
  `pldate` date NOT NULL,
  PRIMARY KEY (`pid`),
  KEY `sid` (`sid`),
  KEY `lid` (`lid`),
  CONSTRAINT `Perform_ibfk_1` FOREIGN KEY (`sid`) REFERENCES `Student` (`sid`),
  CONSTRAINT `Perform_ibfk_2` FOREIGN KEY (`lid`) REFERENCES `Lesson` (`lid`)
